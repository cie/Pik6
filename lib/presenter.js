...
// Timer box
var timer_drag = new Drag('Pik-timecontainer', {
	handle: 'Pik-timecontainer-handle'
});

// Controls box
var controls_drag = new Drag('Pik-framecontrols', {
	handle: 'Pik-framecontrols-handle'
});

// Notes frame
var notes_drag = new Drag('Pik-notes', {
	handle: 'Pik-notes-handle'
});

// All elements must have an incredibly high z-index while being dragged to keep them
// from disappearing behin other elements. This is done using the `pik-dragging` class
