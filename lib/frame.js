...
var reInit = function(){
	...
	// frame The commonPath function (stolen from http://medialize.github.com/URI.js/ by
	// Rodney Rehm) is used to figure out the path
	...
	// Get the new presentation's path and post it to the worker
