...
//
// * `initalized`: True once the worker has been initialized by a presentation instance
...
var local_state = (function(){
	...
	return Object.create(Object.prototype, {
		...
		initalized: {
			enumerable: true,
			get: createGetter('initalized'),
			set: function(value){
				previous_state.initalized = internal_state.initalized;
				internal_state.initalized = value;
				if(!previous_state.initalized){
